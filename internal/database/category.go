...
func (c *Category) Create(name string, description string) (Category, error) {
	...
	if err != nil {
		return Category{}, err // Retorna uma Category em branco
	}

	return Category{ID: id, Name: name, Description: description}, nil // Retorna uma Category, sem retorno de Erro.
}
